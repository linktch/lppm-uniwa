                ...
                <div class="row mb-3 align-items-center">
                    <div class="col-sm-6">
                        <h1 class="academic-page-title">
                            <i class="fas fa-clipboard-list me-2"></i> Rekap Kehadiran Mahasiswa
                        </h1>
                        <p class="text-muted mt-2 mb-0">
                            <i class="fas fa-info-circle me-1"></i>
                            Monitoring kehadiran mahasiswa per minggu (Senin - Kamis)
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="academic-card">
                ...
                <div class="academic-card-header">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        <div>
                            <h3 class="card-title-academic mb-0">Data Kehadiran Mahasiswa</h3>
                                ...
                                <div class="summary-info">
                                    ...
                                    <h3 class="summary-value">
                                        ...
                                        @foreach ($dataMahasiswa as $d)
                                            @php $grand += $d['total_hadir']; @endphp
                                        @endforeach
                                        {{ $grand }}
                                    </h3>
                                </div>
