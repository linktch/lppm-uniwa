    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        <div class="px-5 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
            <div class="flex flex-wrap items-center gap-3">
                ...
                <span class="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded-full">Total: {{ $kelompoks->total() }} Kelompok</span>
            </div>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-32">Kegiatan KKN</th>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="flex gap-2 justify-center">
                                    <a href="{{ route('kegiatan.kkn.kelompok.detail', ['role' => auth()->user()->role, 'kelompokID' => $kelompok->id]) }}" 
                                       wire:navigate 
                                    ...
                                    <button wire:click="$dispatch('confirmDelete', { type: 'kelompok', id: {{ $kelompok->id }} })" 
