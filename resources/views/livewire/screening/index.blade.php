<div class="p-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs md:text-sm text-gray-500">Kelola verifikasi dokumen dan pertanyaan screening
                            KKN</p>
                    </div>
                </div>
            </div>
        ...
        <div class="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden">
            ...
            <div class="p-5">
                ...
                <div class="flex flex-wrap gap-2 mb-4">
                    <span
                        class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-gray-100 text-gray-600 text-xs rounded-full">
                        <i class="fas fa-question-circle"></i> {{ $kesehatanCount ?? 0 }} Pertanyaan
                    </span>
                    <span
                        class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-green-100 text-green-600 text-xs rounded-full">
                        <i class="fas fa-check-circle"></i> {{ $kesehatanAnswered ?? 0 }} Terjawab
                    </span>
                </div>
                <button
                    class="w-full bg-gradient-to-r from-red-500 to-red-400 hover:from-red-600 hover:to-red-500 text-white font-medium py-2.5 rounded-full transition-all duration-200 hover:scale-105">
    ...
    'jenisKegiatan' => $jenisKegiatan ?? 'KKN'
                    ...
                    <i class="fas fa-arrow-right mr-2"></i> Kelola Screening Hafalan
                </a>
            </div>
        </div>
    </div>
