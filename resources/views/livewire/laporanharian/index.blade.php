            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
                <div class="p-5">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <!-- HANYA TAMPIL UNTUK ROLE SUPERADMIN, DOSEN, DAN KEMAHASISWAAN -->
                        ...
                        <div class="flex items-end">
                            @if($canCreateLaporan)
                            <a href="{{ route('kegiatan.laporanharian.create', [
        'role' => $role,
        'jenisKegiatan' => $jenisKegiatan
    ]) }}" wire:navigate class="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition text-center inline-block">
                                <i class="fas fa-plus mr-2"></i>Tambah Laporan
                            </a>
                            @else
                            <div class="relative w-full group">
                                <button disabled
                                    class="w-full bg-blue-600 opacity-50 text-white px-4 py-2 rounded-lg text-sm font-medium cursor-not-allowed">
                                    <i class="fas fa-plus mr-2"></i>Tambah Laporan
                                </button>
                                <div
                                    class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition pointer-events-none whitespace-nowrap z-10">
                                    {{ $timelineMessage }}
                                </div>
                            </div>
                            @endif
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <div class="flex gap-2 justify-center">
                                        ...
                                        <!-- Edit (hanya untuk mahasiswa dengan status revisi) -->
                                        ...
                                        <!-- Delete (hanya untuk pemilik laporan) -->
