...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600;700;800&family=Inter:opsz,wght@14..32,300;400;500;600;700&display=swap"
        rel="stylesheet">
    <style>
    * {
        margin: 0;
            ...
            <div class="page-content">
                <div>
                    <div class="header-container">
                        ...
                        <div class="panitia">
                            {{ $panitia ?? 'PANITIA PELAKSANA KULIAH KERJA NYATA (KKN) TAHUN ' . date('Y') }}</div>
                    ...
                    <div class="preambule-text">
                        Panitia Pelaksana Kuliah Kerja Nyata (KKN) Universitas Wahidiyah Tahun {{ $tahun ?? date('Y') }}
                        memberikan sertifikat ini kepada:
                    </div>
                    ...
                    <div class="lokasi-kkn">
                        ...
                        Universitas Wahidiyah di {{ $kabupaten ?? 'Kabupaten Madiun' }}, Provinsi
                        {{ $provinsi ?? 'Jawa Timur' }}
                    </div>
                ...
                <div>
                    ...
                    <div class="signature-double-wrapper">
                        ...
                        <div class="signature-left">
                            @if(!empty($penanda_tangan['signatur_path']) && file_exists(public_path('storage/' .
                            $penanda_tangan['signatur_path'])))
                            <div class="signature-image">
                                <img src="{{ asset('storage/' . $penanda_tangan['signatur_path']) }}" alt="Tanda Tangan"
                                    style="height: 200px; width: auto; object-fit: contain; margin-bottom: 5px;">
                            </div>
                            @else
                            <div class="signature-line"></div>
                            @endif
                            <div class="signature-name">
                                {{ $penanda_tangan['nama'] ?? auth()->user()->name ?? 'M. Zakaria Yahya, S.P.' }}</div>
                            <div class="signature-title">
                                {{ $penanda_tangan['jabatan'] ?? 'Ketua Panitia Pelaksana KKN' }}</div>
                        </div>

                        <!-- Kanan: Kaprodi -->
                        <div class="signature-right">
                            @if(!empty($kaprodi['signatur_path']) && file_exists(public_path('storage/' .
                            $kaprodi['signatur_path'])))
                            <div class="signature-image">
                                <img src="{{ asset('storage/' . $kaprodi['signatur_path']) }}" alt="Tanda Tangan"
                                    style="height: 200px; width: auto; object-fit: contain; margin-bottom: 5px;">
                            </div>
                            @else
                            <div class="signature-line"></div>
                            ...
                            <div class="signature-title">{{ $kaprodi['jabatan'] ?? 'ketua program studi' }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="certificate-page">
            ...
            <div class="page-content">
                <div>
                    <div class="header-container">
                        <div class="univ-name">{{ $univ_name ?? 'UNIVERSITAS WAHIDIYAH' }}</div>
                        <div class="panitia">PANITIA PELAKSANA KKN TAHUN {{ $tahun ?? date('Y') }} –
                            {{ $kabupaten ?? 'KABUPATEN MADIUN' }}</div>
                    </div>
                    ...
                    <div style="margin-top: 5px; text-align: center;">
                        <div class="recipient-name"
                            style="font-size: 1.3rem; border-bottom: none; display: inline-block; border-bottom: 2px solid #c9a03d; padding-bottom: 4px;">
                            {{ $nama_mahasiswa }}</div>
                        <div class="nim">NIM: {{ $nim }}</div>
                        @if(isset($prodi) && $prodi != '-')
